    ...
    public String login() {
        ...
        try {
            ...
            if (roles.contains("admin")) {
                ...
                UserMaster userObj = pbl.getUserMasterByUserName(username);
                ...
                request.getSession().getServletContext().setAttribute("user", username);
                String user = (String) request.getSession().getServletContext().getAttribute("user");
                UserMaster userObj = pbl.getUserMasterByUserName(username);
                //String image = userObj.getImage();
                //System.out.println("Image is = " + image);
                //request.getSession().getServletContext().setAttribute("image", image);
